...
class Suppliers(models.Model):
    ...
    number_of_buyers = models.IntegerField(max_length=30, null=True)
...
class ShowroomsCarsForSale(models.Model):
    ...
    cars_count = models.IntegerField(max_length=50)
...
class SalesShowroomsBuyers(models.Model):
    ...
    id_car = models.ForeignKey(Cars, on_delete=models.PROTECT, related_name="sales_id_car")
    price = models.IntegerField(max_length=100)
    amount_of_discount = models.IntegerField(max_length=3)
    date_created_in_db = models.DateTimeField(auto_now_add=True)
...
class DiscountShowrooms(models.Model):
    id_showroom = models.IntegerField(max_length=100)
    description = models.TextField(null=True)
    start_time = models.DateTimeField()
    end_time = models.DateTimeField()
    id_car = models.ForeignKey(Cars, on_delete=models.PROTECT, related_name="sales_id_car")  # ????
